...
//        thisIntent = getIntent();
    ...
    private void populateList() {
        ...
        item3 = new purchaseTableModel("2022 Spring pass", "Expired", "01/02/2022", "$500");
        passList.add(item3);

        item4 = new purchaseTableModel("2020 Fall pass", "Expired", "09/02/2020", "$550");
        passList.add(item4);

        item5 = new purchaseTableModel("2018 Spring pass", "Expired", "01/12/2018", "$550");
        passList.add(item5);
